...
def test_get_menus(test_app):
    ...
    assert response.json() == [{"id": menuid, "title": "Menu 1", "description": "My menu 1", "submenus_count": 0, "dishes_count": 0}]
...
def test_edit_menu(test_app):
    ...
    test_response = {"id": menuid,"title": "UPDATED Menu 1", "description": "My UPDATED menu 1", "submenus_count": 0, "dishes_count": 0}
    api_test_menu_id = int(menuid)
...
def test_get_submenus(test_app):
    ...
    assert response.status_code == 200
    assert response.json() == [{"id": submenuid, "title": "Submenu 1", "description": "My submenu 1", "dishes_count": 0}]
...
def test_edit_submenu(test_app):
    ...
    test_response = {"id": submenuid,"title": "UPDATED Submenu 1", "description": "My UPDATED submenu 1", "dishes_count": 0}
    api_test_menu_id = int(menuid)
    api_test_submenu_id = int(submenuid)
...
def test_get_dishes(test_app):
    ...
    assert response.status_code == 200
    assert response.json() == [{"id": dishid, "title": "Dish 1", "description": "My dish 1", "price": "10.00"}]
...
def test_edit_dish(test_app):
    ...
    test_response = {"id": dishid, "title": "UPDATED Dish 1", "description": "My UPDATED dish 1", "price": "10.00"}
    api_test_menu_id = int(menuid)
    api_test_submenu_id = int(submenuid)
    api_test_dish_id = int(dishid)
